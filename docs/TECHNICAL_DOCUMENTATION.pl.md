...
| GUI | PySide6 ≥ 6.7.3 (Qt for Python) | Okno główne, podgląd wideo, panele ustawień; ciemny motyw to arkusz PodTeksT `src/assets/podtekst.qss` z dołączoną czcionką JetBrains Mono (SIL Open Font License) |
...
| `show_hints()` | Pokazuje w pasku stanu do trzech dokończeń literowanego wyrazu ze słownika |
