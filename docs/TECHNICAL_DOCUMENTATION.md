...
| GUI | PySide6 ≥ 6.7.3 (Qt for Python) | Main window, video preview, settings panels; the dark theme is the PodTeksT stylesheet `src/assets/podtekst.qss` with the bundled JetBrains Mono font (SIL Open Font License) |
...
| `show_hints()` | Shows up to three dictionary completions of the word being spelled in the status bar |
